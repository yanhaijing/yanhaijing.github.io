...
## 环境搭建
作为前端开发者，我非常幸运能使用[fis](http://fis.baidu.com/)这么高大上的工具，fis在前不久刚刚发布了fis3，我们用的还是fis2，作为国产工具最大的杯具就是babel不提供默认支持，好的方面是fis团队已经开发出了插件支持——[fis-parser-babel-5.x](https://github.com/fex-team/fis-parser-babel-5.x)。
